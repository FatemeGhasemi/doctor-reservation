...
const findOfficeByInsuranceNameAndGenderAndCategoryId = async (insuranceName, gender, cityName, categoryId) => {
...
module.exports = {findInsuranceById, findInsuranceByName, findOfficeByInsuranceNameAndGenderAndCategoryId}
